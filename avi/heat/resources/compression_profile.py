...
class CompressionProfile(object):
    ...
    compressible_content_uuid_schema = properties.Schema(
        properties.Schema.STRING,
        _("Compress only content types listed in this string group. Content types not present in this list are not compressed. You can either provide UUID or provide a name with the prefix 'get_avi_uuid_by_name:', e.g., 'get_avi_uuid_by_name:my_obj_name'."),
        required=False,
        update_allowed=True,
    )
