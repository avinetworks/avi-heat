...
class AlertObjectList(AviResource):
    ...
    objects_item_schema = properties.Schema(
        ...
        constraints=[
            constraints.AllowedValues(['CLIENTSUMMARYINTERNAL', 'SEHEADLESSONLINEREQ', 'INTERFACESUMMARYRUNTIME', 'VIVCENTERDATACENTERS', 'APICTENANTS', 'VIHOSTRESOURCES', 'REQUESTQUEUERUNTIME', 'CPUUSAGERUNTIME', 'ALERTPARAMS', 'CONTROLLERPROPERTIES', 'ALERTSYSLOGCONFIG', 'DISPATCHERSTATRUNTIME', 'RATELIMITERSTATRUNTIME', 'SEAGENTGRAPHDBRUNTIME', 'APPLICATIONPROFILE', 'L7VIRTUALSERVICESTATSRUNTIME', 'SEFAULTINJECTEXHAUSTMCLSMALL', 'METRICSAGENTMESSAGE', 'STRINGGROUP', 'SEUPGRADESTATUSDETAIL', 'POOLSTATS', 'RTERINGSTATRUNTIME', 'VSDOSSTATRUNTIME', 'GLOBALSERVICE', 'VIRTUALSERVICE', 'VIVCENTERPORTGROUPS', 'SERVERUPDATEREQ', 'SERVERSTATEUPDATEINFO', 'VCENTERMAP', 'POOLGROUP', 'VSCANDIDATESEHOSTLIST', 'GLOBALSITEOPS', 'APICEPGS', 'DISPATCHERTABLEDUMPRUNTIME', 'DATACENTER', 'MICROSERVICEGROUP', 'GLOBALMGRWARMSTART', 'LICENSERUNTIME', 'MALLOCSTATRUNTIME', 'VISUBFOLDERS', 'GLOBALSERVICEHMONSTAT', 'CLUSTER', 'DNSTABLE', 'CLOUD', 'POOLSTATEDBCACHESUMMARY', 'AUTHPROFILE', 'SEAGENTVNICDBRUNTIME', 'SELOGSTATSRUNTIME', 'SEUPGRADESTATUS', 'ACTIONGROUPCONFIG', 'HTTPCACHE', 'APICGRAPHINSTANCES', 'POOLDEBUG', 'CONNECTIONDUMPRUNTIME', 'VIRTUALSERVICEAUTHSTATS', 'GHMTOGSMAPPING', 'METRICSENTITYRUNTIME', 'USER', 'SEMICROSERVICE', 'BGPRUNTIME', 'VIMGRHOSTRUNTIME', 'IPADDRGROUP', 'SEMEMDISTRUNTIME', 'TRANSACTIONSTATS', 'SEDOSSTATRUNTIME', 'VSSCALEOUTLIST', 'SEAUTHSTATSRUNTIME', 'SEFAULTINJECTEXHAUSTM', 'APICTRANSACTION', 'PKIPROFILE', 'SERUMINSERTIONSTATS', 'METRICSSESTATS', 'HTTPCACHESTATS', 'HTTPPOLICYSETSTATS', 'VIRTUALSERVICEANALYSIS', 'APICAGENTINTERNAL', 'SEGROUPREBALANCE', 'INTERFACERUNTIME', 'SEGROUPUPGRADE', 'MIGRATEALLSTATUSDETAIL', 'NETWORKSECURITYPOLICYDOS', 'SERVERRUNTIME', 'DISPATCHERREMOTETIMERLISTDUMPRUNTIME', 'ENTITYCOUNTERS', 'ARPSTATRUNTIME', 'DEBUGSERVICEENGINE', 'VCENTER', 'VINETWORKSUBNETVMS', 'SEUPGRADE', 'METRICSRUNTIMESUMMARY', 'SECONSUMERPROTO', 'DISPATCHERSEHMPROBETEMPDISABLERUNTIME', 'ARPTABLERUNTIME', 'SECREATEPENDINGPROTO', 'PRIORITYLABELS', 'MICROSERVICEGROUPRUNTIME', 'SHAREDDBSTATSCLEAR', 'PERSISTENCEINTERNAL', 'CLOUDCONNECTOR', 'HEALTHMONITORSTATRUNTIME', 'ALERTTYPECONFIG', 'MICROSERVICERUNTIME', 'SEUPGRADEPREVIEW', 'ALGOSTATRUNTIME', 'CLTRACKSUMMARYINTERNAL', 'IPSTATRUNTIME', 'TCPCONNRUNTIMEDETAIL', 'GLOBALLB', 'SHMALLOCSTATRUNTIME', 'IPSTKQSTATSRUNTIME', 'APPLICATION', 'TCPCONNRUNTIME', 'GLOBALHEALTHMONITOR', 'SERESERVEDVSCLEAR', 'POOLSERVER', 'VIMGRVCENTERRUNTIME', 'SERESERVEDVS', 'DISPATCHERSTATCLEARRUNTIME', 'NETWORK', 'HEALTHMONITORRUNTIME', 'INTERESTEDVMS', 'HARDWARESECURITYMODULEGROUP', 'VIRTUALMACHINE', 'CONNPOOLINTERNAL', 'PORTGROUP', 'ANALYTICSPROFILE', 'SSLPROFILE', 'ICMPSTATRUNTIME', 'CIFTABLE', 'MIGRATEALL', 'CLOUDCONNECTORUSER', 'ACTIONGROUPPROFILE', 'PLACEMENTSTATUS', 'SSLKEYANDCERTIFICATE', 'SITECONTROLLERCLUSTER', 'UDPSTATRUNTIME', 'POOLGROUPDEPLOYMENTPOLICY', 'HOST', 'CLIENTINTERNAL', 'HEALTHMONITOR', 'HTTPPOLICYSETINTERNAL', 'MICROSERVICE', 'SEVMCREATEPROGRESS', 'TENANT', 'CPUSTATRUNTIME', 'HTTPPOLICYSET', 'MBSTATRUNTIME', 'CLOUDPROPERTIES', 'SYSTEMCONFIGURATION', 'SERVICEENGINE', 'VSLOGMGRMAP', 'VIRTUALSERVICESTATEDBCACHESUMMARY', 'MIGRATEALLSTATUSSUMMARY', 'APICVMMDOMAINS', 'CLTRACKINTERNAL', 'SEPROPERTIES', 'VSHASHSHOWRUNTIME', 'VRFCONTEXT', 'APICCONFIGURATION', 'SEFAULTINJECTEXHAUSTCONN', 'SERVERSTATEDBCACHESUMMARY', 'APICEPGEPS', 'SHAREDDBSTATS', 'SEFAULTINJECTEXHAUSTMCL', 'KEYVALINTERNAL', 'VIMGRVCENTERCLOUDRUNTIME', 'METRICSRUNTIMEDETAIL', 'MEMINFORUNTIME', 'ALERTEMAILCONFIG', 'KEYVALSUMMARYINTERNAL', 'TCPSTATRUNTIME', 'NETWORKSECURITYPOLICYSTATS', 'GLOBALSERVICERUNTIME', 'IPAMPROFILE', 'VIDATASTORE', 'REBALANCE', 'GLOBALSITEVERIFY', 'SEVM', 'NETWORKSECURITYPOLICY', 'SEWRITEOPSINFO', 'CONTROLLERNODE', 'SNMPTRAPPROFILE', 'MAXOBJECTS', 'SERESOURCEPROTO', 'DEBUGCONTROLLER', 'GLOBALSERVICEINTERNAL', 'L7GLOBALSTATSRUNTIME', 'VCENTERSUPPORTEDCOUNTERS', 'APICDEVICEPKGVER', 'SEAGENTSTATERUNTIME', 'SEVIPPROTO', 'SERVICEENGINEGROUP', 'VIDATASTORECONTENTS', 'ROUTETABLERUNTIME', 'VSDATASCRIPTSET', 'DEBUGVIRTUALSERVICE', 'SEVSLIST', 'AUTOSCALESTATE', 'APICTRANSACTIONFLAP', 'SERVERAUTOSCALEPOLICY', 'NETWORKSECURITYPOLICYDETAIL', 'POOL', 'NETWORKPROFILE', 'CONNPOOLSTATS', 'ALERTCONFIG', 'ROLE', 'AUTOSCALELAUNCHCONFIG', 'INTERESTEDHOSTS', 'APPLICATIONPERSISTENCEPROFILE', 'RMVRFPROTO', 'INTERFACELACPRUNTIME']),
        ],
    )
...
class AlertRuleEvent(object):
    ...
    event_id_schema = properties.Schema(
        ...
        update_allowed=True,
        constraints=[
            constraints.AllowedValues(['VS_THROUGHPUT_LIMIT', 'CONTROLLER_NODE_SHUTDOWN', 'DEL_NW_SE', 'VINFRA_DISC_NW', 'MESOS_ACCESS_FAILURE', 'APIC_CREATE_LIF_CONTEXTS', 'SYSTEM_UPGRADE_COMPLETE', 'PKT_DROP_NO_PKT_BUFF', 'OPENSTACK_ACCESS_FAILURE', 'SE_GROUP_HOST_DEL', 'CONFIG_CREATE', 'ESX_HOST_UNREACHABLE', 'SE_UPGRADING', 'MIGRATE_SE_STARTED', 'VCA_IMAGE_UPLOAD_SUCCESS', 'SE_EV_GS_GROUP_DOWN', 'POOL_HEALTH_DEGRADED', 'CC_VNIC_ADDITION_FAILURE', 'CONN_DROP_NO_PKT_BUFF', 'SE_HEALTH_CHANGE', 'CC_VIP_DNS_REGISTER_FAILURE', 'CC_IP_ATTACHED', 'VCA_IMAGE_UPLOAD_FAILURE', 'GSLB_SITE_CFG_STATUS', 'SE_FATAL_ERROR', 'CC_MARATHON_SERVICE_PORT_OUTSIDE_VALID_RANGE', 'SE_SERVER_DELETED', 'VINFRA_DISC_CLUSTER', 'CREATE_SE_FAIL', 'VS_SCALEOUT_FAILED', 'SE_CONN_MEM_HIGH', 'SUMMARIZED_SUBNETS', 'CREATING_SE', 'APIC_DELETE_LIF_CONTEXTS', 'SE_PKT_BUFF_HIGH', 'CC_VNIC_DELETED', 'POOL_HEALTH_CHANGE', 'APIC_DETACH_CIF_FROM_LIF', 'SERVER_AUTOSCALE_IN_COMPLETE', 'OPENSTACK_IP_DETACH_FAILURE', 'CC_SE_STARTED', 'APIC_CREATE_NETWORK', 'PKT_BUFF_ALLOC_FAIL', 'LS_IMAGE_UPLOAD_FAILURE', 'APIC_ATTACH_CIF_TO_LIF', 'GSLB_SITE_EXCEPTION_STATUS', 'CC_SE_CREATION_FAILURE', 'REBALANCE_VS_MIGRATE', 'SE_VNIC_DUPLICATE_IP', 'LICENSE_EXPIRY', 'OPENSTACK_VNIC_ADDITION_FAILURE', 'CONTROLLER_SERVICE_FAILURE', 'VS_MIGRATE_SCALEOUT_DONE', 'APIC_CREATE_CDEV', 'VS_FSM_DISABLED', 'VCA_ACCESS_FAILURE', 'CONN_DROP_NO_CONN_MEM', 'VM_REMOVED', 'REBOOT_SE', 'VS_RPC_TO_RESMGR_FAILED_EVENT', 'SERVER_AUTOSCALE_OUT', 'CONN_DROP_MAX_FLOW_TBL', 'REBALANCE_VS_SCALEOUT', 'SE_REBOOTED', 'CC_SYNC_SERVICES_SUCCESS', 'ROLLBACK_ALL_SE_DONE', 'DOCKER_UCP_IMAGE_UPLOAD_SUCCESS', 'SE_CPU_HIGH', 'SE_GATEWAY_HEARTBEAT_FAILED', 'SSL_CERT_RENEW_FAILED', 'LICENSE_EXPIRED', 'CC_CONFIG_FAILURE', 'VS_SCALEOUT_COMPLETE', 'IP_POOL_ALMOST_EXHAUSTED', 'APIC_BAD_CREDENTIALS', 'APIC_VS_PLACEMENT', 'VCENTER_ADDRESS_ERROR', 'LS_ACCESS_SUCCESS', 'SE_FLOW_TBL_HIGH', 'POOL_SE_HA_COMPROMISED', 'CC_IP_DETACH_FAILURE', 'VS_SCALEIN_ERR', 'AVG_UPTIME_CHANGE', 'IP_POOL_EXHAUSTED', 'VS_HEALTH_DEGRADED', 'CREATE_SE_TIMEOUT', 'OPENSTACK_LBPROV_AUDIT_SUCCESS', 'SE_EV_GS_MEMBER_DOWN', 'POOL_UP', 'GSLB_GS_STATUS', 'SE_HEALTH_DEGRADED', 'VS_RPC_TO_SE_FAILED_EVENT', 'MESOS_DELETE_SE_FAIL', 'NEW_PROBABLE_SRVR', 'SYSTEM_ROLLBACK_STARTED', 'USER_LOGIN', 'VS_RPC_FAILED_EVENT', 'CONTROLLER_WARM_REBOOT', 'GS_GROUP_DOWN', 'CONTROLLER_NODE_JOINED', 'UPGRADE_ALL_SE_DONE', 'LS_ACCESS_FAILURE', 'CC_HEALTH_FAILURE', 'VS_SCALEOUT_DONE', 'DOCKER_UCP_ACCESS_FAILURE', 'UPGRADE_SE_VS_MIGRATE', 'RM_DEL_NETWORK_FAIL', 'CC_CLUSTER_VIP_DECONFIG_FAILURE', 'GS_MEMBER_DOWN', 'VS_SE_HA_ACTIVE', 'MESOS_ACCESS_SUCCESS', 'UPGRADE_SE_DONE', 'SE_HM_EVENT_SHM_UP', 'NO_HOST_AVAIL', 'OPENSTACK_VNIC_ADDED', 'CC_CLUSTER_VIP_CONFIG_SUCCESS', 'CC_SE_START_FAILURE', 'MESOS_STOP_SE_FAIL', 'SE_HEALTH_CHECK_FAIL', 'SE_VM_DELETED', 'SE_VNIC_DHCP_IP_ALLOC_FAILURE', 'SSL_CERT_EXPIRE', 'OPENSTACK_LBPLUGIN_OP_FAILURE', 'SE_VNIC_IP_ADDED', 'CREATED_SE', 'VINFRA_DISC_COMPLETE', 'VS_FSM_INACTIVE', 'SE_EV_GS_MEMBER_UP', 'MIGRATE_SE_RESTARTED', 'REBALANCE_VS_SCALEIN', 'DOCKER_UCP_IMAGE_UPLOAD_FAILURE', 'LICENSE_LIMIT_HOSTS', 'SE_HM_EVENT_SHM_DOWN', 'CLOUDSTACK_ACCESS_FAILURE', 'VS_SCALEIN_FAILED', 'LICENSE_LIMIT_VS', 'MIGRATE_SE_FAILED', 'MESOS_CREATED_SE', 'SE_EV_GS_UP', 'UPGRADE_SE_START', 'SE_ENABLE', 'OPENSTACK_VNIC_REMOVED', 'OPENSTACK_SE_CREATION_FAILURE', 'CC_SE_DELETION_FAILURE', 'CONTROLLER_SERVICE_CRITICAL_FAILURE', 'SE_EV_POOL_UP', 'CONFIG_INTERNAL_UPDATE', 'SYSTEM_UPGRADE_ABORTED', 'MESOS_IMAGE_UPLOAD_IN_PROGRESS', 'VS_SE_IP_FAIL', 'OPENSTACK_SE_VM_CREATED', 'VS_SE_BOOTUP_FAIL', 'OPENSTACK_IMAGE_UPLOAD_SUCCESS', 'APIC_NETWORK_VRF_CHANGED', 'VCENTER_CONNECTIVITY_FAIL', 'SERVER_AUTOSCALE_IN', 'LICENSE_ADDITION_NOTIF', 'MESOS_UPDATED_HOSTS', 'DELETE_SE_FAIL', 'LS_IMAGE_UPLOAD_SUCCESS', 'OPENSTACK_SE_VM_DELETION_DETECTED', 'LICENSE_LIMIT_THROUGHPUT', 'SE_GROUP_CLUSTER_DEL', 'MIGRATE_SE_VS_MIGRATE_FINISHED', 'SERVER_DELETED', 'APIC_DELETE_NETWORK', 'VS_SCALEIN_DONE_AWAITING_MORE_SE', 'AWS_ACCESS_FAILURE', 'SE_UP', 'SE_MARKED_DOWN', 'SERVER_AUTOSCALE_FAILED', 'MODIFY_NW', 'VS_MIGRATE_SCALEOUT_ERROR', 'SE_HEARTBEAT_FAILURE', 'CC_SE_STOP_FAILURE', 'OPENSTACK_VNIC_DELETION_FAILURE', 'CC_SE_STOPPED', 'GS_DOWN', 'SE_EV_VS_UP', 'CONN_DROP_MAX_SYN_TBL', 'CC_DELETE_VIP_FAILURE', 'CONTROLLER_NODE_DB_REPLICATION_FAILED', 'POOL_DOWN', 'OPENSTACK_IP_DETACHED', 'CC_IP_ATTACH_FAILURE', 'LICENSE_LIMIT_SERVERS', 'VS_INITIAL_PLACEMENT_FAILED', 'SE_VNIC_IP_REMOVED', 'OPENSTACK_SYNC_SERVICES_FAILURE', 'SE_VNIC_DOWN_EVENT', 'SE_HM_EVENT_GHM_UP', 'CC_CLUSTER_VIP_CONFIG_FAILURE', 'CONTROLLER_LEADER_FAILOVER', 'CACHE_OBJ_ALLOC_FAIL', 'CC_UPDATE_VIP_FAILURE', 'VS_SCALEIN_COMPLETE', 'CONFIG_DELETE', 'APIC_DELETE_LIFS', 'CONFIG_UPDATE', 'AWS_IMAGE_UPLOAD_SUCCESS', 'SE_VERSION_CHECK_FAILED', 'MESOS_IMAGE_UPLOAD_FAILURE', 'DELETED_SE', 'CLOUDSTACK_IMAGE_UPLOAD_FAILURE', 'CONFIG_ACTION', 'APIC_DELETE_CDEV', 'SERVER_AUTOSCALE_OUT_COMPLETE', 'VCENTER_CONNECTIVITY_SUCCESS', 'SE_PERSIST_TBL_HIGH', 'GSLB_SITE_OPER_STATUS', 'ADD_NW_FAIL', 'OPENSTACK_SE_VM_DELETED', 'MESOS_START_SE_FAIL', 'MESOS_STOPPED_SE', 'SERVER_HEALTH_CHANGE', 'DOCKER_UCP_IMAGE_UPLOAD_IN_PROGRESS', 'CC_SE_DELETED', 'SE_SYN_TBL_HIGH', 'SERVER_UP_HA_ACTIVE', 'SE_DP_HB_FAILED', 'CLOUDSTACK_IMAGE_UPLOAD_SUCCESS', 'APIC_DELETE_TENANT', 'VS_MIGRATE_SCALEIN_ERROR', 'SERVER_HEALTH_DEGRADED', 'MODIFY_NW_FAIL', 'SE_GATEWAY_HEARTBEAT_SUCCESS', 'SE_DOS_ATTACK', 'VS_FSM_ACTIVE', 'VS_ADD_SE', 'CONTROLLER_NODE_STARTED', 'OPENSTACK_ACCESS_SUCCESS', 'OPENSTACK_IMAGE_UPLOAD_FAILURE', 'MESOS_IMAGE_UPLOAD_SUCCESS', 'MGMT_NW_DEL', 'SE_SERVER_APP_CHANGED', 'UPGRADE_ALL_SE_NOT_NEEDED', 'SE_SERVER_DISABLED', 'VS_FSM_PERMANENT_ERROR', 'APIC_CREATE_LIFS', 'CC_VNIC_ADDED', 'SERVER_AUTOSCALE_OUT_FAILED', 'MIGRATE_SE_VS_MIGRATE_FAILED', 'OPENSTACK_LBPLUGIN_OP_SUCCESS', 'SERVER_DOWN', 'CC_SE_DELETION_DETECTED', 'CC_VNIC_DELETION_FAILURE', 'DISCOVERY_DATACENTER_DEL', 'APIC_CREATE_TENANT', 'DUPLICATE_SUBNETS', 'SSL_CERT_RENEW', 'USER_LOGOUT', 'MGMT_NW_NAME_CHANGED', 'SE_EV_GS_DOWN', 'METRICS_DB_DISK_FULL', 'ESX_HOST_POWERED_DOWN', 'SYSTEM_UPGRADE_STARTED', 'SE_DOWN', 'CC_SE_CREATED', 'VS_FSM_UNEXPECTED_EVENT', 'ADD_VIP_VNIC', 'LICENSE_LIMIT_SE_SOCKETS', 'VINFRA_DISC_DC', 'GS_MEMBER_UP', 'VS_MIGRATE_FAILED', 'VS_UP', 'SYSTEM_ROLLBACK_COMPLETE', 'VS_REMOVED_SE_INT', 'SE_EV_GS_GROUP_DELETED', 'VS_MIGRATE_COMPLETE', 'MESOS_STARTED_SE', 'GS_GROUP_UP', 'VS_MIGRATE_STARTED', 'VS_FSM_TRANSIENT_ERROR', 'CC_GENERIC_FAILURE', 'CC_MARATHON_SERVICE_PORT_ALREADY_IN_USE', 'CC_CLUSTER_VIP_DECONFIG_SUCCESS', 'SE_EV_SERVER_DOWN', 'VS_AWAITING_SE', 'DOS_ATTACK', 'SE_POOL_DELETED', 'SE_MEM_HIGH', 'VS_REMOVED_SE', 'POOL_SE_HA_ACTIVE', 'VS_SCALEOUT_DONE_AWAITING_MORE_SE', 'MIGRATE_SE_VS_MIGRATE_STARTED', 'SE_MIGRATE', 'OPENSTACK_TENANTS_DELETED', 'GS_UP', 'SE_EXTERNAL_HM_RESTART', 'ROLLBACK_ALL_SE_START', 'POOL_AUTO_DEPLOYMENT_FAILED', 'OPENSTACK_LBPROV_AUDIT_FAILURE', 'VS_FSM_PARTITIONED', 'SE_EV_GS_GROUP_UP', 'GSLB_DNS_STATUS', 'USER_PASSWORD_CHANGE_REQUEST', 'VS_SE_HA_COMPROMISED', 'VINFRA_DISC_VM', 'OPENSTACK_SYNC_SERVICES_SUCCESS', 'LICENSE_LIMIT_SE_VCPUS', 'POOL_AUTO_DEPLOYMENT_SUCCESS', 'SE_HM_EVENT_GHM_DOWN', 'OPENSTACK_IP_ATTACH_FAILURE', 'CLOUDSTACK_ACCESS_SUCCESS', 'AWS_ACCESS_SUCCESS', 'DOCKER_UCP_ACCESS_SUCCESS', 'CC_SYNC_SERVICES_FAILURE', 'VS_FSM_ACTIVE_AWAITING_SCALEOUT_READY', 'VS_DOWN', 'MESOS_DELETED_SE', 'VS_ADD_SE_INT', 'SE_POWERED_DOWN', 'MESOS_CREATE_SE_FAIL', 'VS_SCALEOUT_ERR', 'SERVER_UP', 'CC_TENANT_INIT_FAILURE', 'SERVER_AUTOSCALE_IN_FAILED', 'DEL_VIP_VNIC', 'VINFRA_DISC_FAILURE', 'VCA_ACCESS_SUCCESS', 'VS_MIGRATE_SCALEIN_DONE', 'SSL_KEY_EXPORTED', 'CONTROLLER_NODE_LEFT', 'CONN_DROP_POOL_LB_FAILURE', 'VINFRA_DISC_HOST', 'CC_IP_DETACHED', 'UPGRADE_SE_VS_DISRUPTED', 'VS_FSM_AWAITING_SE_ASSIGNMENT', 'UPGRADE_SE_NOT_NEEDED', 'SE_GROUP_MGMT_NW_DEL', 'METRIC_THRESHOLD_UP_VIOLATION', 'SERVER_DOWN_HA_COMPROMISED', 'UPGRADE_ALL_SE_START', 'UPGRADE_SE_VS_SCALEIN', 'APIC_BIND_VNIC_TO_NETWORK', 'ADD_NW_SE', 'SE_EV_SERVER_UP', 'VS_FSM_ACTIVE_AWAITING_SE_TRANSITION', 'VS_MIGRATE_DONE', 'CONFIG_INTERNAL_CREATE', 'UPGRADE_SE_VS_SCALEOUT', 'CONTROLLER_SERVICE_RESTORED', 'AWS_IMAGE_UPLOAD_FAILURE', 'OPENSTACK_SE_DELETION_FAILURE', 'DELETING_SE', 'VS_CONN_LIMIT', 'CONN_DROP_MAX_PERSIST_TBL', 'SYSTEM_ROLLBACK_ABORTED', 'VS_HEALTH_CHANGE', 'SE_DISK_HIGH', 'ANOMALY', 'VS_SWITCHOVER', 'SE_EV_POOL_DOWN', 'OPENSTACK_IP_ATTACHED', 'VCENTER_BAD_CREDENTIALS', 'VM_ADDED', 'VCENTER_VERSION_NOT_SUPPORTED', 'CC_HEALTH_OK', 'SE_EV_VS_DOWN', 'VS_SCALEIN_DONE', 'CC_DECONFIG_FAILURE', 'SE_SYN_CACHE_USAGE_HIGH', 'LICENSE_REMOVAL_NOTIF', 'MIGRATE_SE_FINISHED', 'VS_SWITCHOVER_FAIL', 'SE_VM_PURGED']),
        ],
    )
